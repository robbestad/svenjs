	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return ( /******/(function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _libJsx = __webpack_require__(10);
			...
			/***/function (module, exports) {
				...
				function toDOM(parts) {
					...
					var xmlstr = parts.reduce(function (xmlstr, part, i) {
						xmlstr += part;
						if (i != parts.length - 1) {
							// the last part has no ending param
							xmlstr += '__' + i;
						}
				...
				function toFragment(node, params) {
					var match;
					...
					reactNode = match ? params[parseInt(match[1])] : node.localName;
					...
					// recursively turn children into DOM fragments
					var reactChildren = [];
					for (var i = 0; i < node.childNodes.length; i++) {
						var child = node.childNodes[i];
						var reactChild = toFragment(child, params);
						if (reactChild) {
				...
				exports.jsx = function (parts) {
					...
					var doc = toDOM(parts);
					return toFragment(doc.firstChild, params);
				};
