...
/***/ function(module, exports, __webpack_require__) {
	...
	var timeTravel = Svenjs.createComponent({
	  ...
	  render: function render() {
	    ...
	    return { tag: 'div', attrs: { id: 'row' }, children: [{ tag: 'div', attrs: { id: 'app' }, children: [{ tag: 'h3', attrs: {}, children: [this.state.message || 'Sample App'] }, { tag: 'button', attrs: { id: 'add', onClick: myFunc }, children: ['Add word'] }, { tag: 'div', attrs: { id: 'ui' } }, { tag: 'small', attrs: {}, children: ['(click word to delete)'] }] }, { tag: 'div', attrs: { id: 'time-travel' }, children: [{ tag: 'h3', attrs: {}, children: ['Time travel'] }, { tag: 'button', attrs: { id: 'back', disabled: backDisabled, onClick: this.goBack.bind(this) }, children: ['Back'] }, { tag: 'button', attrs: { id: 'next', disabled: nextDisabled, onClick: this.goForward.bind(this) }, children: ['Next'] }, { tag: 'p', attrs: { id: 'time-pos' } }] }] };
	  }
	});
